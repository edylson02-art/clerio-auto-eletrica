...
export default function Hero() {
  return (
    <section className="relative min-h-[88vh] overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-[88vh] max-w-[1500px] flex-col justify-center px-6 lg:px-10 xl:px-8">
        <motion.div
        ...
        >
          ...
          <h1 className="mt-8 max-w-[900px] text-[58px] font-black leading-[0.94] tracking-tight md:text-[78px] xl:text-[92px]">
            Seu carro
            <span className="block text-yellow-400">em boas mãos!</span>
          </h1>

          <p className="mt-6 max-w-[680px] text-[21px] font-medium leading-relaxed text-white">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <a
              ...
              className="relative inline-flex h-14 items-center justify-center gap-3 overflow-hidden rounded-xl bg-gradient-to-r from-yellow-400 to-orange-500 px-8 text-sm font-black uppercase text-black shadow-2xl shadow-orange-500/40 transition hover:scale-105"
            >
            ...
            <a
              href="#servicos"
              className="inline-flex h-14 items-center justify-center gap-3 rounded-xl border border-yellow-400/70 bg-black/40 px-8 text-sm font-black uppercase text-white backdrop-blur transition hover:bg-yellow-400 hover:text-black"
            >
              Ver serviços
              <ChevronDown size={19} />
            </a>
